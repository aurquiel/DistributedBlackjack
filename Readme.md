...
- **Orquestación de rondas:** la ronda inicia cuando todos los jugadores conectados el servidor resparte los turnos y los jugadores apuestan, cuando todos tienen apuesta > 0, el servidor reparte las cartas y luego rota turnos con `\x`, y al finalizar ejecuta automáticamente el turno del crupier hasta 17–21 o puede perder.
